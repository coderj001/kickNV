...
-- Colour changes for popup window in LspSignature
vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", { bg = "#45403d", fg = "NONE" })
vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#282828", fg = "NONE" })
vim.api.nvim_set_hl(0, "FloatBorder", { bg = "#282828", fg = "NONE" })
