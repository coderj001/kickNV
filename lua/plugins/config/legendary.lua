...
function M.setup()
  require('legendary').setup({
    keymaps = {
      ...
      { '<leader>sc', function () require('plugins.config.telescope').colorscheme_picker() end, description = '[S]earch [C]olorscheme' },
      { '<leader>so', function () require('plugins.config.telescope').treesitter() end, description = '[S]earch Treesitter Symb[o]ls' },
      ...
      { '<leader>sj', telescope_builtin.jumplist, description = '[S]earch [J]umplists' },
      { '<leader>st', telescope_builtin.tags, description = '[S]earch [T]ags' },
      { '<leader>/', require("plugins.config.telescope").current_buffer_fuzzy_find, description = '[/] Fuzzily search in current buffer' },
      { '<leader>en', require("plugins.config.telescope").edit_neovim, description = '[E]dit [N]eovim' },
      ...
      { '<leader>L', ':Neogit commit<cr>', description = 'NeoGit', mode = { 'n' } },
      -- Split
