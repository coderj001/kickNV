...
function M.setup()
  require('legendary').setup({
    keymaps = {
      ...
      { '<leader>sc', function () require('plugins.extras.telescope').colorscheme_picker() end, description = '[S]earch [C]olorscheme' },
      { '<leader>so', function () require('plugins.extras.telescope').treesitter() end, description = '[S]earch Treesitter Symb[o]ls' },
      ...
      { '<leader>/', require('plugins.extras.telescope').current_buffer_fuzzy_find, description = '[/] Fuzzily search in current buffer' },
      { '<leader>en', require('plugins.extras.telescope').edit_neovim, description = '[E]dit [N]eovim' },
