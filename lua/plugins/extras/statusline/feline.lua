local get_palette = function()
  -- Define your color scheme palette here
  -- Replace these colors with your preferred colors
  -- return {
  --   lavender = "#b48ead",
  --   green = "#a3be8c",
  --   flamingo = "#d08770",
  ...
  table.insert(components_right, {
    provider = function()
      ...
      for _, lsp_config in ipairs(active_clients) do
        ...
        local lsp_name = config.lsp.server_to_name_map[lsp_config.name] == nil and lsp_config.name or
            config.lsp.server_to_name_map[lsp_config.name]
