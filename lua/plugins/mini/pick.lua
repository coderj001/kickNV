...
function M.setup()
  ...
  map('n', '<leader>sgc', ':Pick git_commits path="%"<cr>', { noremap = true, silent = true, desc = 'Search buffer commits' })
  ...
  map('n', '<leader>sgu', ':Pick git_hunks scope="unstaged"<cr>', { noremap = true, silent = true, desc = 'Search git hunks unstaged' })
